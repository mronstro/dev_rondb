...
public:
  ...
  struct Subscriber {
    STATIC_CONST( TYPE_ID = RT_SUMA_SUBSCRIBER_RECORD);
    Uint32 m_magic;
  ...
  STATIC_CONST(SUMA_SUBSCRIBER_RECORD_TRANSIENT_POOL_INDEX = 3);
  ...
  STATIC_CONST(SUMA_DATA_BUFFER_TRANSIENT_POOL_INDEX = 4);
  ...
  STATIC_CONST(SUMA_SUB_OP_RECORD_TRANSIENT_POOL_INDEX = 1);
  ...
  struct SubOpRecord
  {
    STATIC_CONST( TYPE_ID = RT_SUMA_SUB_OP_RECORD);
    Uint32 m_magic;
  ...
  struct Subscription
  {
    STATIC_CONST( TYPE_ID = RT_SUMA_SUBSCRIPTION_RECORD);
    Uint32 m_magic;
  ...
  STATIC_CONST(SUMA_SUBSCRIPTION_RECORD_TRANSIENT_POOL_INDEX = 0);
  ...
  struct Table {
    STATIC_CONST( TYPE_ID = RT_SUMA_TABLE_RECORD);
    Uint32 m_magic;
  ...
  STATIC_CONST(SUMA_TABLE_RECORD_TRANSIENT_POOL_INDEX = 2);
...
#define NUM_LDM_TRIGGER_PAGE_RECORDS 4
  struct Trigger_page_chunk
  {
    ...
    STATIC_CONST( PAGES_PER_CHUNK = 32);
    STATIC_CONST( MIN_PAGES_PER_CHUNK = 2);
    Uint32 m_page_id;
    Uint32 m_count;
